...
const COPY = {
  en: {
    ...
    analyzerReadError: 'Unable to read this file right now.'
  }
}
...
async function extractTextFromFile(file) {
  ...
  // Direct text read for text-like files
  if (
    type.startsWith('text/') ||
    /(\.txt|\.md|\.json|\.csv|\.js|\.jsx|\.ts|\.tsx|\.html|\.css|\.xml)$/i.test(name)
  ) {
    return await file.text()
  }

  // PDFs: send through OCR/parser endpoint immediately so PDFs are actually readable
