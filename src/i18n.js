export const translations = {
  en: {
    ...
    channels_loading: 'Loading trade boards…',
    channels_unavailable: 'Trades Unavailable',
    channels_error: 'Unable to load trades right now.',
    channels_title: 'Trade Boards',
    channels_intro:
      'Browse local discussions by trade, or jump straight into opportunities like Need Crew and Looking for Work.',
    channels_empty_title: 'No Trades Yet',
    channels_empty_body: 'Trade boards have not been created yet.',
    channels_view_posts: 'View nearby posts in this trade',
    channels_quick_actions: 'Quick Actions',
    channels_quick_actions_intro:
      'Use these shortcuts when you need help fast or want to get in front of nearby crews.',
    channels_need_crew_title: 'Need Crew',
    channels_need_crew_body:
      'Post a local crew request for nearby laborers and subcontractors to see.',
    channels_need_crew_button: 'Create Need Crew Post',
    channels_work_title: 'Looking for Work',
    channels_work_body:
      'Post your availability so nearby contractors and crews can find you.',
    channels_work_button: 'Create Looking for Work Post',
    channels_all_trades_title: 'Browse Trades',
    channels_all_trades_intro:
      'Choose a trade board below to view local posts in that trade.',
  ...
  es: {
    ...
    channels_empty_body: 'Aún no se han creado tableros de oficio.',
    channels_view_posts: 'Ver publicaciones cercanas en este oficio',
    channels_quick_actions: 'Accesos rápidos',
    channels_quick_actions_intro:
      'Usa estos accesos cuando necesites ayuda rápido o quieras llegar a cuadrillas cercanas.',
    channels_need_crew_title: 'Se necesita cuadrilla',
    channels_need_crew_body:
      'Publica una solicitud local de cuadrilla para que la vean trabajadores y subcontratistas cercanos.',
    channels_need_crew_button: 'Crear publicación de cuadrilla',
    channels_work_title: 'Buscando trabajo',
    channels_work_body:
      'Publica tu disponibilidad para que contratistas y cuadrillas cercanas puedan encontrarte.',
    channels_work_button: 'Crear publicación de trabajo',
    channels_all_trades_title: 'Explorar oficios',
    channels_all_trades_intro:
      'Elige un tablero de oficio abajo para ver publicaciones locales de ese oficio.',
